package com.example.androidslimesoccer.practice;
...
public class PracticeLogicProvider {
    ...
    public void doSpecial() {
        if (specialSprite.slimeType == SlimeType.INDIAN) {
            ...
            specialSprite.isOnDraw = slimeSprite.specialCountDown == 0 || slimeSprite.specialCountDown >= Utils.slimeMaxSpecialTime - 5;
